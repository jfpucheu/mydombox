...
void message_0X11(char message[255]){
	...
	if ( DB_MYSQL == 1){
		...
		mysql_insert("INSERT IGNORE INTO devices (dc_id,last_update,packettype,subtype,int_id,id1,id2,id3,id4,unitcode,com) SELECT MAX(dc_id)+1,NOW(),'%02hhX','%02hhX',1,'%02hhX','%02hhX','%02hhX','%02hhX',%d,'tx' FROM devices ON DUPLICATE KEY UPDATE last_update=NOW();\
					INSERT INTO state (dc_id,datetime,device_mode,dim_level,signal_level) VALUES ((select dc_id from devices where id1='%02hhX' AND id2='%02hhX' AND id3='%02hhX' AND id4='%02hhX' AND unitcode=%d LIMIT 1),NOW(),'%s',%d,%d)\
					ON DUPLICATE KEY UPDATE device_mode='%s',dim_level=%d,signal_level=%d;\
...
void message_0X14(char message[255]){
	...
	if ( DB_MYSQL == 1){
		...
		mysql_insert("INSERT IGNORE INTO devices (dc_id,last_update,packettype,subtype,int_id,id1,id2,id3,unitcode,com) SELECT MAX(dc_id)+1,NOW(),'%02hhX','%02hhX',1,'%02hhX','%02hhX','%02hhX',%d,'tx' FROM devices ON DUPLICATE KEY UPDATE last_update=NOW();\
					INSERT INTO state (dc_id,datetime,device_mode,dim_level,signal_level) VALUES ((select dc_id from devices where id1='%02hhX' AND id2='%02hhX' AND id3='%02hhX' AND unitcode=%d LIMIT 1),NOW(),'%s','%02hhX',%d)\
					ON DUPLICATE KEY UPDATE device_mode='%s',dim_level='%02hhX',signal_level=%d;\
					",packettype,subtype,id1,id2,id3,unitcode,id1,id2,id3,unitcode,cmnd_text,level,rssi,cmnd_text,level,rssi);
	}
...
void message_0X1A(char message[255]){
	...
	if ( DB_MYSQL == 1){
		...
		mysql_insert("INSERT IGNORE INTO devices (dc_id,last_update,packettype,subtype,int_id,id1,id2,id3,unitcode,com) SELECT MAX(dc_id)+1,NOW(),'%02hhX','%02hhX',1,'%02hhX','%02hhX','%02hhX',%d,'tx' FROM devices ON DUPLICATE KEY UPDATE last_update=NOW();\
				INSERT INTO state (dc_id,datetime,device_mode,signal_level) VALUES ((select dc_id from devices where id1='%02hhX' AND id2='%02hhX' AND id3='%02hhX' AND unitcode=%d LIMIT 1),NOW(),'%s',%d)\
				ON DUPLICATE KEY UPDATE device_mode='%s',signal_level=%d;\
				",packettype,subtype,id1,id2,id3,unitcode,id1,id2,id3,unitcode,cmnd_text,rssi,cmnd_text,rssi);
	}
}
...
void message_0X40(char message[255]){
	...
	if ( DB_MYSQL == 1){
		...
		mysql_insert("INSERT IGNORE INTO devices (dc_id,last_update,packettype,subtype,int_id,id1,id2,com,home_data1) SELECT MAX(dc_id)+1,NOW(),'%02hhX','%02hhX',1,'%02hhX','%02hhX','tx', %d FROM devices ON DUPLICATE KEY UPDATE last_update=NOW(),home_data1=%d;\
					INSERT INTO temperature (dc_id,datetime,seqnbr,temperature,temperature_set,mode,status,signal_level) VALUES ((select dc_id from devices where id1='%02hhX' AND id2='%02hhX' LIMIT 1),NOW(),%d,%d,%d,'%s','%s',%d);\
					",packettype,subtype,id1,id2,temperature,temperature,id1,id2,seqnbr,temperature,temperature_set,mode_text,status_text,rssi);
	}
...
void message_0X5A(char message[255]){
	...
	if ( DB_MYSQL == 1){
		...
		mysql_insert("INSERT IGNORE INTO devices (dc_id,last_update,packettype,subtype,int_id,id1,id2,com,home_data1) SELECT MAX(dc_id)+1,NOW(),'%02hhX','%02hhX',1,'%02hhX','%02hhX','tx', %d FROM devices ON DUPLICATE KEY UPDATE last_update=NOW(),home_data1=%d;\
					INSERT INTO energy (dc_id,datetime,count,instant,total,battery,signal_level) VALUES ((select dc_id from devices where id1='%02hhX' AND id2='%02hhX' LIMIT 1),NOW(),%d,%d,%lld,%d,%d);\
					",packettype,subtype,id1,id2,instant,instant,id1,id2,count,instant,total,battery_level,rssi);
	}
...
void message_0X52(char message[255]){
	...
	if ( DB_MYSQL == 1){
		...
		mysql_insert("INSERT IGNORE INTO devices (dc_id,last_update,packettype,subtype,int_id,id1,id2,com,home_data1,home_data2) SELECT MAX(dc_id)+1,NOW(),'%02hhX','%02hhX',1,'%02hhX','%02hhX','tx',%.2f,%d FROM devices ON DUPLICATE KEY UPDATE last_update=NOW(),home_data1=%.2f,home_data2=%d;\
					INSERT INTO weather (dc_id,datetime,seqnbr,temperature,humidity,humidity_status,battery,signal_level) VALUES ((select dc_id from devices where id1='%02hhX' AND id2='%02hhX' LIMIT 1),NOW(),%d,%.2f,%d,'%s',%d,%d);\
					",packettype,subtype,id1,id2,temperature,humidity,temperature,humidity,id1,id2,seqnbr,temperature,humidity,humidity_text,battery_level,rssi);
	}
...
void message_0X55(char message[255]){
	...
	if ( DB_MYSQL == 1){
		...
		mysql_insert("INSERT IGNORE INTO devices (dc_id,last_update,packettype,subtype,int_id,id1,id2,com,home_data1,home_data2) SELECT MAX(dc_id)+1,NOW(),'%02hhX','%02hhX',1,'%02hhX','%02hhX','tx',%.2f,%.2f FROM devices ON DUPLICATE KEY UPDATE last_update=NOW(),home_data1=%.2f,home_data2=%.2f;\
					INSERT INTO weather (dc_id,datetime,seqnbr,rainrate,raintotal,battery,signal_level) VALUES ((select dc_id from devices where id1='%02hhX' AND id2='%02hhX' LIMIT 1),NOW(),%d,%.2f,%.2f,%d,%d);\
					",packettype,subtype,id1,id2,rainrate,raintotal,rainrate,raintotal,id1,id2,seqnbr,rainrate,raintotal,battery_level,rssi);
	}
		// MDB CLOUD
	if ( MDB_CLOUD == 1){
		...
		if (( iss_status == 1) && ( enable == 1) && (deleted== 0)){
			...
			post_stream_value(iss_stream,"[{ \"value\": \"%d\" }]",raintotalmm);
		}
	}
}
...
void message_0X56(char message[255]){
	...
	//WIND 4 (more informations)
		...
		if ( DB_MYSQL == 1){
			...
			mysql_insert("INSERT IGNORE INTO devices (dc_id,last_update,packettype,subtype,int_id,id1,id2,com,home_data1,home_data2,home_data3) SELECT MAX(dc_id)+1,'NOW()','%02hhX','%02hhX',1,'%02hhX','%02hhX','tx',%d,%d,%d FROM devices ON DUPLICATE KEY UPDATE last_update=NOW(),home_data1=%d,home_data2=%d,home_data3=%d;\
					INSERT INTO weather (dc_id,datetime,seqnbr,winddirection,av_speed,gust,temperature,windchill,battery,signal_level) VALUES ((select dc_id from devices where id1='%02hhX' AND id2='%02hhX' LIMIT 1),NOW(),%d,%d,%d,%d,%.2f,%.2f,%d,%d);\
					",packettype,subtype,id1,id2,winddirection,av_speed,gust,winddirection,av_speed,gust,id1,id2,seqnbr,winddirection,av_speed,gust,temperature,windchill,battery_level,rssi);
		}
	}
	else
	{
		...
		if ( DB_MYSQL == 1){
			...
			mysql_insert("INSERT IGNORE INTO devices (dc_id,last_update,packettype,subtype,int_id,id1,id2,com,home_data1,home_data2,home_data3) SELECT MAX(dc_id)+1,'NOW()','%02hhX','%02hhX',1,'%02hhX','%02hhX','tx',%d,%d,%d FROM devices ON DUPLICATE KEY UPDATE last_update=NOW(),home_data1=%d,home_data2=%d,home_data3=%d;\
					INSERT INTO weather (dc_id,datetime,seqnbr,winddirection,av_speed,gust,battery,signal_level) VALUES ((select dc_id from devices where id1='%02hhX' AND id2='%02hhX' LIMIT 1),NOW(),%d,%d,%d,%d,%d,%d);\
					",packettype,subtype,id1,id2,winddirection,av_speed,gust,winddirection,av_speed,gust,id1,id2,seqnbr,winddirection,av_speed,gust,battery_level,rssi);
		}
	}
