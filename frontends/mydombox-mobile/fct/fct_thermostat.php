...
function TH_NEW(){
	...
	$order = "INSERT INTO thermostat (th_id,th_name,th_use,th_mode,tp_set,sc_id,home_screen) SELECT (SELECT MAX(th_id)+1 FROM thermostat) as th_id,'New Thermostat','off','manual',18,0,'1';";
