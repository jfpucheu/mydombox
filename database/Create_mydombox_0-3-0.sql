...
--
-- Client: localhost
-- Généré le: Jeu 17 Avril 2014 à 14:39
...
CREATE TABLE IF NOT EXISTS `devices` (
  ...
  `home_data1` float(5,2) DEFAULT NULL,
  `home_data2` float(5,2) DEFAULT NULL,
...
INSERT INTO database_version VALUES ('0.3.0',now(), 'Create_mydombox_0-3-0');
